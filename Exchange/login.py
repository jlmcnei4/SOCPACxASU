...
from exchangelib import Credentials, Account, DistributionList
...
def updateCredentials(username, password):
    global credentials, account, folder
    credentials = Credentials(username, password)
    try:
        account = Account(userCreds.u, credentials=credentials, autodiscover=True)
